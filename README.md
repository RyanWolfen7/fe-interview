...
1. Another tab should show a list of transactions which are potential bills. These can also be found at http://localhost:3001/bills/. Potential bills have a flag `isBill` set to `false`.
